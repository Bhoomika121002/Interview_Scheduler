const mongodbUri = "mongodb+srv://bchaudhary12102:qzKuKH0TNUpclJkl@cluster0.hlnzzoc.mongodb.net/interviewscheduler?retryWrites=true&w=majority";
...
const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "b.chaudhary12102@gmail.com",
    pass: "nvulsmutsazqzsmp"//get this password from two step authentication of gmail.
  }
});
...
app.post('/sign_up', async function (req, res) {
	...
	isValid = totalResult.isValid
	errors = totalResult.errors
// vaild is 1 but take 0 and works for 2 user to make it 1 
	if (isValid === 1) {
		//Meeting is valid
		...
		var message = "You are invited for an interview That will start at " + startTime + " and end at " + endTime
